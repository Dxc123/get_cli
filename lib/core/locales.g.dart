...
class LocaleKeys {
  ...
  static const hint_generate_icons = 'hint_generate_icons';
  ...
  static const hint_clean_all = 'hint_clean_all';
...
class Locales {
  static const tr_TR = {
    ...
    'hint_generate_icons': 'Icon oluşturur',
    ...
    'hint_clean': '清理当前目录下的Flutter项目并节省磁盘空间！🚀',
    'hint_clean_all': '清理当前目录下所有Flutter项目并节省磁盘空间！🚀',
  ...
  static const zh_CN = {
    ...
    'hint_generate_icons': '生成 icon 文件',
    'hint_help': '显示本帮助',
  ...
  static const de = {
    ...
    'hint_clean': 'Löschen Sie den gesamten Flutter-Projekt',
    'hint_clean_all': '清理当前目录下所有Flutter项目并节省磁盘空间！🚀',
  ...
  static const en = {
    ...
    'hint_generate_icons': 'Generate icons',
    ...
    'hint_clean': 'Clean your flutter projects that are inside the the current directory!!！🚀',
    'hint_clean_all': 'Clean all your flutter projects that are inside the the current directory!!！🚀',
